 ...
 *******************************************************************************/
package com.zjb.loader.internal.core.listener;
...
import com.zjb.loader.internal.core.ImageLoader;

/**
 * Listener-helper for {@linkplain AbsListView list views} ({@link ListView}, {@link GridView}) which can
 * {@linkplain ImageLoader#pause() pause ZjbImageLoader's tasks} while list view is scrolling (touch scrolling and/or
...
public class PauseOnScrollListener implements OnScrollListener {
	 ...
	 * @param pauseOnScroll Whether {@linkplain ImageLoader#pause() pause ZjbImageLoader} during touch scrolling
	 * @param pauseOnFling  Whether {@linkplain ImageLoader#pause() pause ZjbImageLoader} during fling
	 */
